...
Source0  : https://xcb.freedesktop.org/dist/xcb-util-cursor-0.1.4.tar.gz
Source1  : https://xcb.freedesktop.org/dist/xcb-util-cursor-0.1.4.tar.gz.sig
...
%prep
%setup -q -n xcb-util-cursor-0.1.4
cd %{_builddir}/xcb-util-cursor-0.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666126513
...
cp %{_builddir}/xcb-util-cursor-%{version}/COPYING %{buildroot}/usr/share/package-licenses/xcb-util-cursor/4f5fe1d01f48c63ff77cb43066137d8140f902aa
%make_install
